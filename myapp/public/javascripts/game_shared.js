...
/* when code is running, disable all inputs */
...
/* re-enable inputs once code has finished running */
...
/* fills the puzzle dropdown with the puzzle names */
...
/* user selects a different puzzle */
...
/* returns the percentage a puzzle is worth */
...
/* returns the new completion percentage for a user */
...
function update_per_text(username, new_per) {
  ...
  /* submit a puzzle to the server to determine if the user solved this
     puzzle for the first time, or in a new language */
...
/* 
  ...
  @param outcome_msg   message to display in user's browser, stating the outcome 
                        of the game for that user
*/
